...
function init_config()
    local fluids_config = {
        --    fluid name                fluid label                             (fluid amount) (amnt per item) (item name)           (damage)(item label)
            ...
            { "molten.inconel792",      "Molten Inconel-792",                            18432, 144, "miscutils:itemIngotInconel792", 0,     "Inconel-792 Ingot" },
            { "molten.tungstentitaniumcarbide", "Molten Tungsten Titanium Carbide",      18432, 144, "miscutils:itemIngotTungstenTitaniumCarbide", 0, "Tungsten Titanium Carbide Ingot" },
            { "molten.zeron100",        "Molten Zeron-100",                              7200,  144, "miscutils:itemIngotZeron100",  0,      "Zeron-100 Ingot" },
